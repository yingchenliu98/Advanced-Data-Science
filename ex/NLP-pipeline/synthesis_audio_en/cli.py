...
def synthesis():
    print("synthesis")
    shutil.rmtree(text_audios,ignore_errors=False, onerror=None)
    os.makedirs(text_paragraphs, exist_ok=True)
    os.makedirs(text_audios, exist_ok=True)
    ...
    for text_file in text_files:
        ...
        text_path = os.path.join(text_paragraphs, text_file)
        audio_path = os.path.join(text_audios, audio_file)
